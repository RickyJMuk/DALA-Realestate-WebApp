...
// Function to get total rows for a specific table
function getTotalRows($tableName, $conn) {
...
$totalRowsContactUs = getTotalRows('contact_us', $conn);
$totalRowsNewsletter = getTotalRows('newsletter', $conn);
$totalRowsUsers = getTotalRows('users', $conn);
$totalRowsMessages = getTotalRows('messages', $conn);
                            ...
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $totalRowsNewsletter;?></div>
                                            <div>All Newsletter Requests</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $totalRowsContactUs; ?></div>
                            ...
                            <div class="panel panel-red">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $totalRowsUsers; ?></div>
                                            <div>All Users</div>
                                        </div>
                                    </div>
                                </div>
