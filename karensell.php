...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="images/properties/karensell1.jpeg" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->

        <!-- Item 2 -->
        <div class="item">
          <img src="images/properties/karensell2.jpeg" class="properties" alt="properties" />
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="images/properties/karensell3.jpeg" class="properties" alt="properties" />
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="images/properties/karensell4.jpeg" class="properties" alt="properties" />
...
<!-- #Slider Ends -->
  ...
  <p>This 4-bedroom master en-suite villa with a self-contained DSQ in a gated community located in Fourways Junction, Kiambu road which offers peace and serenity to its inhabitants. It’s a very secure neighborhood along Kiambu road after the Northern by-pass and a UN approved zone. It is 5 minutes’ drive to the Ridgeways mall, the new Naivas mall and 15 minutes’ drive to the UN.</p>
  <p>Ultra Modern Minimalist design is what you can use to describe this house. Located in Karen opposite Karen view estate. It has boasted of the following features; – There two townhouses sharing a total of a 1-acre plot – It Consists of 4 bedrooms and 5 bedroom houses – Double volume lounge with wall to ceiling windows, modern fireplace, and fantastic view from the lounge – Formal Dining with wrap-around windows and a balcony – Modern Gourmet Kitchen with a Scandinavian feel – All rooms are en suite – Outdoor Patio – Both properties come with an infinity swimming pool. Next to the pool is an inbuilt sauna – The property has a small stream of fresh water from Ngong Hills. Sale Price : 4 Bedroom (4500 Sq ft): 60 Million 5 bedroom (6000 Sq ft ): 70 Million ( Incomplete) Sale for Both 110Million.
</p>
 
  
  </div>
  <div><h4><span class="glyphicon glyphicon-map-marker"></span> Location</h4>
<div class="well"><iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d127640.51270566457!2d36.691809!3d-1.3159520000000002!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f1c809869d64b%3A0x199b5604a77f13f5!2sKaren%2C%20Nairobi%2C%20Kenya!5e0!3m2!1sen!2sus!4v1704642284984!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
  </div>
...
<p class="price">Ksh 20,000,000</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span> Karen, Nairobi </p>
  
  <div class="profile">
  <span class="glyphicon glyphicon-user"></span> Agent Details
  <p>VAAL<br>+254 7134 565 65</p>
  </div>
</div>
