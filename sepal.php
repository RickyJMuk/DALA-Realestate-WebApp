...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="images/properties/sepal1.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->

        <!-- Item 2 -->
        <div class="item">
          <img src="images/properties/sepal2.jpg" class="properties" alt="properties" />
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="images/properties/sepal3.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="images/properties/sepal4.jpg" class="properties" alt="properties" />
...
<!-- #Slider Ends -->
  ...
  <p>Sepal Gardens comprises 2 bedrooms all en-suite plus DSQ along Gatundu close, Kileleshwa. Has a total of 56 units in total, with 6 units per floor:- </p>
  <p>Roof top infinity swimming pool<br>
Fully fitted gym<br>
DSTV and WIFI provision<br>
2 covered parking slots per unit<br>
Ample visitors parking<br>
Game zone and borehole<br>
Video door phone<br>
Full security system with electric fencing<br>
Standby generator<br>
Large communal foyers<br>
UPVC / Aluminium windows with mosquito netting<br>
Sound proof doors and windows <br>
Security steel entrance doors<br>
Fitted wardrobes and en-suite bathroom<br>
Solid strand woven bamboo wooden flooring in all bedrooms<br>
Separate cloak room toilet<br>
Individual DSQ with separate entrance<br>
Dhobi and wash area<br>
Open plan dining room<br>
Imported modular kitchen with LED internal light and granite work tops<br>
Breakfast bar<br>
Wash hand basin in dining area<br>
Just 6 units per floor</p>
  
  <p><b><i>2 bedroom (all en-suite plus DSQ, 167 sq.m / 1,800 sq.m) –</i></b> <b>From Kes. 18M</b> <br>
  <b><i> Furnished available: </i></b> <b> From Kes 240,000 per month (11,000 daily rate)</p>
  </div>
  <div><h4><span class="glyphicon glyphicon-map-marker"></span> Location</h4>
<div class="well"><iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.8207217901445!2d36.78116577393745!3d-1.2812917356185205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f1102e09ce0d9%3A0x5f0c1c03ca4e4742!2sSEPAL%20GARDENS%20-%20KILELESHWA!5e0!3m2!1sen!2ske!4v1704557432241!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
  </div>
...
<p class="price">Ksh 18,000,000</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span> Gatundu close </p>
