...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="images/properties/eden1.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->

        <!-- Item 2 -->
        <div class="item">
          <img src="images/properties/eden2.jpg" class="properties" alt="properties" />
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="images/properties/eden3.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="images/properties/eden4.jpg" class="properties" alt="properties" />
...
<!-- #Slider Ends -->
  ...
  <p>Eden Garden comprises of 2 bedroom all en-suite apartments in Lavington, along Hatheru road. Has close proximity to major educational, social and recreational facilities/amenities. Comprises of 72 units on 12 floors (6 apartments on each floor) </p>
  <p>Project Amenities: High speed elevators, anti-termite treatment to the foundation, heated swimming pool, Steam and Sauna, fully equipped gym, generator backup for common area, borehole and concealed wiring, CCTV, manned security.  </p>
  <p>Project finish features: Solid wooden door with safety lock, vitrified tiles, all en-suite, superior quality paint, UPVC Windows, anti-skid flooring tiles in balcony and open plan modular kitchen.</p>
  <p><b><i>Sale option:</i></b> <b>Kes. 12.5M – 13M</b> <br>
  <b><i> Rental Option:</i></b> <b> Kes. 75,000 (inclusive) – Asking two month’s refundable deposit</p>
  </div>
  <div><h4><span class="glyphicon glyphicon-map-marker"></span> Location</h4>
<div class="well"><iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127641.70384823755!2d36.60969444335937!3d-1.2924666999999737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f1ba2bf86a4cb%3A0x8e77084c5c57ee1!2sKings%20Eden%20Garden!5e0!3m2!1sen!2ske!4v1704556497176!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
  </div>
...
<p class="price">Ksh 13,000,000</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span> Lavington, Hatheru </p>
